		...
		<form name="view" method="POST" action="index3.php">
			...
			<div class="row">
				<div class="col-12">
                    ...
                    <p class="title text-center">遊戲銷量</p>
					<hr class="title_line">
				</div>
			</div>
			<div class="row">
            ...
            <form method="POST" action="month.php">
                年份:<input type="text" size="10" name="Year" id="textfield" value="2021"/>年
                月份:<input list="Month" name="Month" id="textfield" />月
                    <datalist id="Month">
                        <option value="01">
                        <option value="02">
                        <option value="03">
            ...
            <form method="POST" action="this.php">
			    <input type="submit" value="今年查詢"/>
            </form>
            <form method="POST" action="last1.php">
			    <input type="submit" value="去年查詢"/>
            </form>
            <form method="POST" action="last2.php">
			    <input type="submit" value="前年查詢"/>
            </form>
