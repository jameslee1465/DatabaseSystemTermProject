...
<body>
    ...
    <div class="product" id="section1">
		<div class="container">
		<form name="view" method="POST" action="game_ana.php?year=<?php echo intval($_POST['Year'])?>">
			...
			<div class="row">
				<div class="col-12">
                    ...
                    <hr class="title_line">
                    <h1><?php echo intval($_POST['Year'])?>年<?php echo intval($_POST['Month'])?>月遊戲銷量</h1><br>
<table border=1  cellpadding=5>
            ...
            <?php
                ...
                $monthh = intval($_POST['Month']) + 1;
                $sql="SELECT `GameID`,Count(*) FROM `orderlist` WHERE `AddTime` >= '$year-$month-01 00:00:00' AND `AddTime` < '$year-$monthh-01 00:00:00' GROUP BY `GameID`";
                $stmt = $conn->query($sql)
            ?>
            <?php
